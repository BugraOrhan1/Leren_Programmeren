...
def analyseer_getallenlijst(getallen:list, controlegetal1:int, controlegetal2:int) -> dict:
    ...
    verschil1 = min_fun(aantal_unieke_elementen,controlegetal1)
    ...
    deelbaar1 = check_deelbaar(unieke_getallen,controlegetal1)
    ...
    deelbaar2 = check_deelbaar(unieke_getallen,controlegetal2)
    # for getal in unieke_getallen:
    ...
    posities = posities_fun(controlegetal1,getallen)
    ...
    standaardafwijking = afwijking(gemiddelde,getallen,aantal)
    ...
    verschil2 = min_fun(random_getal,controlegetal2)
